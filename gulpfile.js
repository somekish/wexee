...
const gulp         = require('gulp'), // Подключаем Gulp
      ...
      cache        = require('gulp-cache'), // Подключаем библиотеку кеширования(gulp clear)
...
gulp.task('sass', function() { // Создаем таск Sass
    return gulp.src('./sass/**/*.sass') // Берем источник
        ...
        .pipe(gulp.dest('./css/min')) // Выгружаем в папку 
...
return gulp.src('./pug/pages/**/*.pug')   // код для pug - html
    .pipe(pug({
    pretty: true
    }))
    .pipe(gulp.dest('./'))
